...
export default function Token() {
    ...
    return <Card>
        ...
        <CardFooter className="flex flex-row gap-4 border-t p-6">
            <Button className="flex flex-row gap-2" onClick={postToken} disabled={token !== ""}>
                <Plus className="h-4 w-4" />
                Generate
            </Button>
            <Button variant={"outline"} className="flex flex-row gap-2" onClick={copyToken} disabled={token === ""}>
